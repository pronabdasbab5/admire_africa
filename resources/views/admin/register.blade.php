...
<head>
    ...
    <title>Admire Africa | Admin Register</title>
    ...
    <div class="middle-box text-center loginscreen   animated fadeInDown">
        <div>
            <div>
                ...
                <h1 class="logo-name">Admire Africa</h1>

            </div>
            <h3>Register to Admire Africa Admin</h3>
            ...
            <p class="m-t"> <small>Developed by WebInfotech</small> </p>
        </div>
    </div>
